    ...
    <div class="form-container">
        ...
        <table class="table">
            ...
            <tbody>
                ...
                <tr>
                    <td scope="row"><%= accounts.getAccNo() %></td>
                    <td scope="row"><%= accounts.getAccName() %></td>
                    <td scope="row"><%= accounts.getAccMob() %></td>
                    <td scope="row"><%= accounts.getAccType() %></td>
                    <td scope="row"><%= accounts.getAccBal() %></td>
                </tr>
